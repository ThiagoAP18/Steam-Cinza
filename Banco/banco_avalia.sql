...
CREATE TABLE `avalia` (
  ...
  `fk_Jogo_id_jogo` int DEFAULT NULL,
  `id_avaliacao` int NOT NULL,
  `nota_avaliacao` int DEFAULT NULL,
  `desc_avaliacao` varchar(2000) DEFAULT NULL,
  `dt_avaliacao` date DEFAULT NULL,
  PRIMARY KEY (`id_avaliacao`),
  UNIQUE KEY `id_avaliacao` (`id_avaliacao`),
  KEY `FK_Avalia_2` (`fk_Usuario_id_usuario`),
  KEY `FK_Avalia_3` (`fk_Jogo_id_jogo`),
  CONSTRAINT `FK_Avalia_2` FOREIGN KEY (`fk_Usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE SET NULL,
  CONSTRAINT `FK_Avalia_3` FOREIGN KEY (`fk_Jogo_id_jogo`) REFERENCES `jogo` (`id_jogo`) ON DELETE SET NULL
