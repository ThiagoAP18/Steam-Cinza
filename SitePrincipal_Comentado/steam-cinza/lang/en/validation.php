Aqui está a tradução completa do arquivo `validation.php` para o Português do Brasil (pt-BR), mantendo toda a estrutura do array, as chaves originais e as variáveis (como `:attribute`, `:value`, `:min`, etc.) intactas para que o Laravel funcione corretamente.
...
return [
    ...
    | pela classe validadora. Algumas dessas regras têm múltiplas versões, como
    ...
    */
    ...
    | especificar uma linha de linguagem personalizada específica para uma regra de atributo fornecida.
    |
    */
